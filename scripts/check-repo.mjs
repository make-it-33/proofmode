...
const requiredFiles = [
  ...
  "apps/web/src/arena.css", "apps/web/src/lock-choice.css", "apps/web/src/light-surface-contrast.css", "apps/web/src/website.css", "apps/web/src/today.css", "apps/web/src/onboarding.css",
  "apps/web/src/routes/WebsiteRoute.tsx", "apps/web/src/routes/TodayRoute.tsx", "apps/web/src/routes/OnboardingRoute.tsx",
  "apps/web/src/domain/todayState.ts", "apps/web/src/domain/onboardingState.ts", "apps/web/src/domain/practiceDebrief.ts",
  "apps/web/test/runState.test.ts", "apps/web/test/todayState.test.ts", "apps/web/test/onboardingState.test.ts",
  "apps/web/e2e/player-shell.spec.ts", "apps/web/e2e/today-shell.spec.ts", "apps/web/e2e/onboarding-flow.spec.ts",
  ...
  "docs/design/README.md", "docs/design/CASEFILE_GATE3_V1.md", "docs/design/AGENT_ARENA_DIRECTION_V1.md", "docs/design/AGENT_ARENA_GATE3_V1.md", "docs/design/TODAY_DESKTOP_SHELL_V1.md", "docs/design/ONBOARDING_FIELD_BOUNDARY_V1.md",
...
for (const route of ["<Route index element={<WebsiteRoute />} />", '<Route path="play" element={<PromiseRoute />} />', '<Route path="app" element={<TodayRoute />} />', '<Route path="app/onboarding" element={<OnboardingRoute />} />']) {
